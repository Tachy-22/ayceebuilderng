...
import { MapPin, Star, ArrowRight, Loader2, Clock, Briefcase, Award } from "lucide-react";
...
const tradesmen = [
  {
    id: "t1",
    name: "John Carpenter",
    photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bWFuJTIwZmFjZXxlbnwwfHwwfHx8MA%3D%3D",
    trade: "Carpentry",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8d29tYW4lMjBmYWNlfGVufDB8fDB8fHww",
    trade: "Electrical",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1hbiUyMGZhY2V8ZW58MHx8MHx8fDA%3D",
    trade: "Plumbing",
  ...
  },
  {
    id: "t4",
    name: "David Painter",
    photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1hbiUyMGZhY2V8ZW58MHx8MHx8fDA%3D",
    trade: "Painting",
    location: "Lagos, Nigeria",
    rating: 4.6,
    reviewCount: 38,
  ...
  },
  {
    id: "t5",
    name: "Grace Tiler",
    photo: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8d29tYW4lMjBmYWNlfGVufDB8fDB8fHww",
    trade: "Tiling",
  ...
  },
  {
    id: "t6",
    name: "Robert Mason",
    photo: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fG1hbiUyMGZhY2V8ZW58MHx8MHx8fDA%3D",
    trade: "Masonry",
...
const Tradesmen = () => {
  ...
  const [tradesmanForm, setTradesmanForm] = useState({
    formType: "tradesman", // To indicate this is from the tradesman form
    fullName: "",
    trade: "",
    phoneNumber: "",
    email: "",
    ...
    if (searchQuery) {
      results = results.filter(
        (tradesman) =>
          ...
          tradesman.description.toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
  ...
  }, [searchQuery, tradeFilter, locationFilter]);
  ...
  const handleTradesmanSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      Object.entries(tradesmanForm).forEach(([key, value]) => {
        ...
        <div className="bg-secondary/5 py-10">
          <div className="container mx-auto px-4">
            ...
            <p className="text-muted-foreground mb-6">
              Find skilled professionals for your building projects or register as a tradesman
            </p>
            ...
            >
              <TabsList className="grid w-full max-w-md grid-cols-2 mb-8">
                ...
                <TabsTrigger value="register">Register as Tradesman</TabsTrigger>
              </TabsList>
        ...
        <div className="container mx-auto px-4 py-10">
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-lg font-medium">{tradesman.name}</h3>
                      ...
                      <div className="flex flex-wrap gap-4 text-sm">
                        ...
                        <div className="flex items-center">
                          ...
                          />
                          <span className="font-medium">{tradesman.rating}</span>
                          <span className="text-muted-foreground ml-1">
              ...
              {submitSuccess ? (
                <div className="text-center py-8 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-green-700 mb-6">
                    Thank you for registering as a tradesman. Our team will review your information and contact you shortly.
                  </p>
                  <Button onClick={() => setSubmitSuccess(false)}>Register Another Tradesman</Button>
                </div>
              ) : (
                <>
                  <div className="bg-primary/5 p-6 rounded-lg mb-8">
                    <h2 className="text-xl font-bold mb-3">Join Our Network of Construction Professionals</h2>
                    <p className="text-muted-foreground">
                      Register below to be featured on Ayceebuilder as a skilled tradesman. Connect with clients looking for your expertise and grow your business.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleTradesmanSubmit} className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="trade">Trade <span className="text-red-500">*</span></Label>
                          <Select 
                            name="trade" 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select 
                            name="availability" 
                            value={tradesmanForm.availability}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="skillDescription">Describe Your Skills <span className="text-red-500">*</span></Label>
                        <Textarea
                          id="skillDescription"
                          name="skillDescription"
                          value={tradesmanForm.skillDescription}
                          onChange={handleInputChange}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="portfolioLink">Portfolio Link (if any)</Label>
                        <Input
                          id="portfolioLink"
                          name="portfolioLink"
                          type="url"
          ...
          {activeTab === "browse" && (
            <div className="mt-10 bg-secondary/5 rounded-xl p-6">
              <h3 className="text-lg font-medium mb-2">Are you a skilled tradesman?</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Join Ayceebuilder as a verified professional and connect with clients looking for your skills.
              </p>
