          ...
          <div className="  w-full lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/products" aria-label="Go to Products page">
                <Button size="lg" className="w-full sm:w-auto" aria-label="Shop Now">
                  Shop Now
          ...
          >
            <motion.div className="lg:col-span-3" variants={fadeIn}>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/building-quotation" aria-label="Try Building Quotation Tool">
                ...
                <Link href="/products" aria-label="Shop Products">
                  <Button size="lg" variant="outline" aria-label="Shop Products">
                    Shop Products
                  </Button>
                </Link>
              </div>
              ...
              >
                ...
                >
                  <span className="flex items-center">
                    ...
                    Become a Vendor <ArrowRight size={16} className="ml-2" aria-hidden="true" />
                  </span>
                </Button>
              </a>
            </div>
